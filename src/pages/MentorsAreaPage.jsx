...
const mentors = [
  { name: 'Shahbaz Ahmed', expertise: 'Freelancing, Scientific Writing, Marketing', imageAlt: 'Professional photo of Shahbaz Ahmed', profileLink: '/shahbaz' },
  { name: 'Gulbaz Ahmed', expertise: 'Remote Work Strategies, Side Hustles', imageAlt: 'Professional photo of Gulbaz Ahmed', profileLink: '#' },
];
    ...
    <div className="space-y-16 md:space-y-24">
      ...
      >
        <div className="container mx-auto px-4">
          ...
          >
            Get 1:1 Mentorship from Veteran Freelancers
          </motion.h1>
          <motion.p
            className="text-xl md:text-2xl text-foreground/80 mb-10 max-w-3xl mx-auto"
            initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4, duration: 0.5 }}
          >
            Accelerate Your Freelancing Career or Side Hustle with Personalized Guidance
          </motion.p>
          <motion.div
      ...
      <section className="bg-primary/10 py-16 md:py-24">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-10 text-foreground">Hire Me On Freelancing Platforms</h2>
...
export default MentorsAreaPage;